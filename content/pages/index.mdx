...
>
> **Brave** has also lost Manifest V2 support — [the MV2 code was removed](https://community.brave.app/t/some-extensions-suddenly-turned-off-because-they-are-no-longer-supported/655075/3) from upstream Chromium by Google.
> If you use Brave and need to export your data, **downgrade in place** to [v1.91.178](https://github.com/brave/brave-browser/releases/tag/v1.91.178) first to re-enable your extensions.
